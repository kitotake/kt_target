-- client/defaults.lua
-- Interactions par défaut sur les véhicules (portes, capot, coffre).
-- Désactivable via convar kt_target:defaults = 0
...
local function canInteractWithDoor(entity, coords, door, useOffset)
    if not GetIsDoorValid(entity, door) then return end
